const NEX_TOKEN_ADDRESS = "COLOQUE_AQUI_ENDERECO_DO_TOKEN"; // Deploy feito na Arbitrum / Testnet
const NEX_ABI = [
...
function quickReceive() {
    showToast("Mostre seu QR para receber NEX");
}
function quickSwap() {
    showToast("Swap interno $NEX / USDT em breve");
}
